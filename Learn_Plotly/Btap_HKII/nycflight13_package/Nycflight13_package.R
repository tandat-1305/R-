  ...
  add_markers(x ~dep_delay, y = ~arr_delay,
              marker = list(size = 8,
                            ...
                            line = list(color = 'rgba(33, 197, 211, 1)',
                                        width = 2))) %>%
  layout(title = 'Chuyen bay cua hãng ALASKA AIRLINE',font = fontStyle)
#==============================================================================
#CAU 2
str(weather)
data(weather)
...
data2 %>%
  ...
  layout(title = 'Nhiet do các ngày trong tháng 1',font = fontStyle)
#==============================================================================
#CAU 3
t <- count(weather,vars=temp)
names(t)[1] <- paste("temp")
...
data4%>%
  ...
  layout(title = 'Su phân bo cua nhiet do theo các tháng',font=fontStyle)
#==============================================================================
#CAU 5
...
data5 %>%
  ...
  layout(title = 'So chuyen bay cua các hang hang khong',font = fontStyle)
